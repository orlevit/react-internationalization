...
(async () => {
  try {
    ...
    // await mongoose.connect(MONGO_URL); // Commented out for mocking
    // logger.info('connected to db'); // Commented out for mocking
...
app.prepare().then(async () => {
  ...
  const sessionOptions = {
    ...
    // store: mongoSessionStore.create({ // Commented out for mocking
    //   mongoUrl: MONGO_URL,
  ...
  setupGoogle({ server, ROOT_URL }); // Re-enabled for mock login flow
